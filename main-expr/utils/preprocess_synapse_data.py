...
for split in splits:
    ...
    print(dirname)
    if(split == 'train'):
        ct_path = os.path.join(dirname, './data/Synapse/Abdomen/RawData/TrainSet/img') # set your path to your trainset directory
        seg_path = os.path.join(dirname, './data/Synapse/Abdomen/RawData/TrainSet/label')
        save_path = os.path.join(dirname, './data/Synapse/train_npz_new/')
    else:
        ct_path = os.path.join(dirname, './data/Synapse/Abdomen/RawData/TestSet/img') # set your path to your testset directory
        seg_path = os.path.join(dirname, './data/Synapse/Abdomen/RawData/TestSet/label')
        save_path = os.path.join(dirname, './data/Synapse/test_vol_h5_new/')

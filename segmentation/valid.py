...
from meseg.dataset import get_dataset
from meseg.model import get_model
from meseg.engine import test
from meseg.utils.setup import print_batch_run_settings, clear
from meseg.utils import setup, get_args_with_setting, compute_metrics
from meseg.dataset.abdomen import btcv_v2_inference
...
def get_args_parser():
    ...
    setup.add_argument(
        '--mode', type=str, default='test', choices=['valid', 'test'],
    ...
    model.add_argument(
        ...
        help='like timm or torchvision'
    )
    setup.add_argument(
        '-weights', '--model-weights', type=str, default=[], nargs='+',
...
def run(args, valid_dataset, valid_dataloader):
    ...
    print('Successfully Load pretarined weights!!!')

    if args.dataset_type == 'btcv_v2': # synapse 2015
        result = btcv_v2_inference(valid_dataloader, args, model)
...
if __name__ == '__main__':
    ...
    for setting in args.settings:
        ...
        for model_name in new_args.model_names:
            ...
            new_args.checkpoint_path = model_weight_dict.get(new_args.model_name, None)
